...
class SimSpace:
    ...
    def create_niche(self, 
                     ...
                     neighborhood: list = spatial.generate_offsets(5, 'manhattan')
                     ) -> None:
        """
        ...
        Args:
            ...
            neighborhood (list): The list of neighboring cells, generated by spatial.generate_offsets.
        Raises:
    ...
    def density_sampler(self, 
        ...
        Args:
            threshold (float or list): The threshold for the density sampler. 
    ...
    def create_niche3D(
            ...
            n_iter: int = 10, 
            theta_niche: np.ndarray = None,
            neighborhood: np.ndarray = spatial.generate_offsets3D(5, 'manhattan'),):
        """
